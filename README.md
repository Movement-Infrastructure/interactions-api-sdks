...
| Ruby | [`ddx_interactions_api`](https://rubygems.org/gems/ddx_interactions_api) | Available |
| Node.js | — | Planned |
...
// BasePath is a full URL, scheme included - unlike the Ruby client, which
// splits host and scheme.
