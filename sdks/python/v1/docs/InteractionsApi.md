# mi_interactions_api.InteractionsApi
...
with mi_interactions_api.ApiClient(configuration) as api_client:
    ...
    api_instance = mi_interactions_api.InteractionsApi(api_client)
...
> ExternalApiTransactionDtoGetResponseDto vversion_interactions_interaction_id_transactions_get(interaction_id, version, show_only_failed_transactions=show_only_failed_transactions)
...
[**ExternalApiTransactionDtoGetResponseDto**](ExternalApiTransactionDtoGetResponseDto.md)
...
> InteractionDto vversion_interactions_post(version, interactions_dto=interactions_dto)
...
with mi_interactions_api.ApiClient(configuration) as api_client:
    ...
    api_instance = mi_interactions_api.InteractionsApi(api_client)
    version = '1' # str |  (default to '1')
    interactions_dto = mi_interactions_api.InteractionsDto() # InteractionsDto |  (optional)
...
[**InteractionDto**](InteractionDto.md)
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Successfully published interactions |  -  |
**400** | Invalid interactions data |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **vversion_interactions_transactions_get**
> ExternalApiTransactionDtoGetResponseDto vversion_interactions_transactions_get(version, start_date=start_date, end_date=end_date, show_only_failed_transactions=show_only_failed_transactions)
