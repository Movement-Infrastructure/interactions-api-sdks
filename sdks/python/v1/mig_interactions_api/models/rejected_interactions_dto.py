...
class RejectedInteractionsDto(BaseModel):
    """
    Represents a collection of rejected interactions along with their count.
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The total number of rejected interactions.")
    data: Optional[List[RejectedInteractionDto]] = Field(default=None, description="The list of rejected interactions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "data": [RejectedInteractionDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
