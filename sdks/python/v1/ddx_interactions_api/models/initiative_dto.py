...
class InitiativeDto(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of the initiative identifier specified in 'id'.")
    id: Optional[StrictStr] = Field(default=None, description="The actual initiative identifier, such as a campaign ID.")
    name: Optional[StrictStr] = Field(default=None, description="Descriptive name or title for the initiative.")
