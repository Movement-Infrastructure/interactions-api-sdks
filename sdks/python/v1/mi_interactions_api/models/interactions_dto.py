...
class InteractionsDto(BaseModel):
    """
    InteractionsDto
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interactions": [InteractionDto.from_dict(_item) for _item in obj["interactions"]] if obj.get("interactions") is not None else None
        })
        return _obj
